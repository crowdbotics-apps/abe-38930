"""
Django settings for abe_38930 project.
...
WSGI_APPLICATION = 'abe_38930.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "abe_38930 API",
    "DESCRIPTION": "API documentation for abe_38930 App",
    "VERSION": "v1",
}
